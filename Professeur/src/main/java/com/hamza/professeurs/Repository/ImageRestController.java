...
import com.hamza.professeurs.service.ImageService;
...
public class ImageRestController {
	...
	@PostMapping(value = "/uplaodImageProf/{idProf}")
	public Image uploadMultiImages(@RequestParam("image") MultipartFile file, @PathVariable("idProf") Long idProf)
			throws IOException {
		return imageService.uplaodImageProf(file, idProf);
	}

	@RequestMapping(value = "/getImagesProf/{idProf}", method = RequestMethod.GET)
	public List<Image> getImagesProf(@PathVariable("idProf") Long idProf) throws IOException {
		return imageService.getImagesParProf(idProf);
	}
